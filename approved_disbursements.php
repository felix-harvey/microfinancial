...
<body class="bg-gray-bg">
            ...
            <i class="fa-solid fa-eye-slash"></i>
                                        ...
                                        <td>
                                            <div class="flex flex-wrap gap-2">
                                                <button class="action-btn delete" title="Delete Request" onclick="deleteRequest(<?php echo $request['id']; ?>)">
    ...
    <script>
        ...
        window.deleteRequest = function(requestId) {
            if (confirm('Are you sure you want to delete this approved disbursement request? This action cannot be undone.')) {
                // Show loading state
                ...
                // Simulate API call - in real implementation, you would make an AJAX call to your backend
                setTimeout(() => {
                    alert('Disbursement request #' + requestId + ' has been deleted successfully.');
                    // In real implementation, you would reload the page or remove the row from the table
